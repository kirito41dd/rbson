...
use crate::de::{read_u32, read_u64};
...
impl<'de> Deserializer<'de> {
        ...
        V: serde::de::Visitor<'de>,
    {
        ...
        match self.current_type {
            ...
            ElementType::UInt32 => visitor.visit_u32(read_u32(&mut self.bytes)?),
            ElementType::UInt64 => visitor.visit_u64(read_u64(&mut self.bytes)?),
